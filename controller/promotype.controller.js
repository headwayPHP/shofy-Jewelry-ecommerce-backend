...
exports.deletePromoType = async (req, res, next) => {
    try {
        const result = await promotypeServices.deletePromoTypeService(req.body.id);
        res.status(200).json({
            success: true,
            result,
        })
...
exports.updatePromoType = async (req, res, next) => {
    try {
        const result = await promotypeServices.updatePromoTypeService(req.body.id, req.body);
        res.status(200).json({
            status: 'success',
            message: 'PromoType update successfully',
            result,
        })
    } catch (error) {
        next(error)
...
exports.getSinglePromoType = async (req, res, next) => {
    try {
        const result = await promotypeServices.getSinglePromoTypeService(req.body.id);
